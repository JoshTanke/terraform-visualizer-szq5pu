...
const ComputeEngineIcon = React.memo<GCPIconProps>(({
...
const VPCNetworkIcon = React.memo<GCPIconProps>(({
  size = DEFAULT_ICON_SIZE,
  color = DEFAULT_ICON_COLOR,
  className,
  title
...
const CloudSQLIcon = React.memo<GCPIconProps>(({
  size = DEFAULT_ICON_SIZE,
  color = DEFAULT_ICON_COLOR,
  className,
  title
...
const CloudStorageIcon = React.memo<GCPIconProps>(({
  size = DEFAULT_ICON_SIZE,
  color = DEFAULT_ICON_COLOR,
  className,
  title
...
// IAM Icon Component
const IAMIcon = React.memo<GCPIconProps>(({
  size = DEFAULT_ICON_SIZE,
  color = DEFAULT_ICON_COLOR,
  className,
  title
